...
|-----|---------------|-----------|-------|-------------|
| AM62A | Entry-level ML | 1-2 CSI-Rx | Low | Assist (basic) |
| TDA4VL | Mid-level deep learning | 2 CSI-Rx | Medium | Assist, Control, Fleet |
| TDA4VM | High-performance deep learning | 4 CSI-Rx | Higher | Control, Fleet, Fusion |
